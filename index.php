...
<head>
	...
	<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false);
		...
		<link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous"> <!-- Font-Awesome-Icons-CSS -->
		<!-- //css files -->
					...
					<div class="agileits_main_grid w3_agileits_main_grid">
						<div class="wthree_grid">
							...
							<select id="category" name="category" required="">
								...
								<option value="category1">Deluxe Doube Room (Non AC)</option>
								<option value="category2">AC Deluxe Double Room</option>
						...
						<div class="row wpb_row row-fluid">
							...
							<!-- <div class="col-sm-2 col-xs-6 wpb_column column_container ">
								<div class="wpb_wrapper">
									...
									<div class="usp">
										<div class="box-icon">
											<div class="circle"><i class="fa fa fa-pied-piper-alt fa-lg"></i></div>
											<h3>Room service</h3>
											<p>
											</p>
										</div>
							...
							<div class="col-sm-2 col-xs-6 wpb_column column_container ">
								<div class="wpb_wrapper">
									...
									<div class="usp">
										<div class="box-icon">
											<div class="circle"><i class="fa fa fa-windows fa-lg"></i></div>
											<h3>Laundry</h3>
											<p></p>
										</div>
									</div>
							...
							<div class="col-sm-2 col-xs-6 wpb_column column_container ">
									<div class="wpb_wrapper">									
										<div class="usp">
											<div class="box-icon">
												<div class="circle"><i class="fa fa fa-steam fa-lg"></i></div>
